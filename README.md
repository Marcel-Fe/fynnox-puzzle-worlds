...
npm test         # Logik-Tests (110 Stück) — müssen grün sein
...
| 6 | Die weiteren sieben Spiele | 3 von 7 |
| 7 | Abenteuerpfad, Events, Shop | offen |
| 8 | Cloud-Save, Ranglisten, Einstellungen, Ton | offen |

**Spielbar**: Waldblöcke, Blockfall, Tempelpaare und Kristallmix.
...
Die übrigen vier Spiele stehen als „Bald" auf dem Dashboard.
