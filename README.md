...
npm test         # Logik-Tests (147 Stück) — müssen grün sein
...
| 6 | Die weiteren sieben Spiele | 4 von 7 |
| 7 | Abenteuerpfad, Events, Shop | offen |
| 8 | Cloud-Save, Ranglisten, Einstellungen, Ton | offen |

**Spielbar**: Waldblöcke, Blockfall, Tempelpaare, Kristallmix und Sudoku.
...
Die übrigen drei Spiele stehen als „Bald" auf dem Dashboard.
